                                                ...
                                                <div class="entry-content">
                                                    <p>
                                                       ...
                                                       <ul class="list-group" style="line-height: 25px; list-style-type: circle;">
                                                            <li class="myli_for_page"> Institute of Technology &amp; Sciences (AITS)</li>
                                                            <li class="myli_for_page"> Institute of Management &amp; Computer Applications (AIMCA)</li>
                                                            <li class="myli_for_page"> Institute of Hospitality Management (AIHM)</li>
                                                            <li class="myli_for_page" class="myli_for_page"> Institute of Applied Sciences (AIAS)</li> 
                                                        </ul>
                                                    </p>
                                                    <p>
