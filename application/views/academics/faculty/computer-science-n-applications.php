                                                    ...
                                                    <p>
                                                        <div class="col-sm-12">
                                                            <ul style="list-style-type: circle !important" id="integration-list">
                                                                <li class="myli_for_page">Masters of Computer Applications [<b>MCA</b>]</li>
                                                                <li class="myli_for_page">Masters of Computer Applications Lateral Entry [<b>MCA - Direct IInd year</b>]</li>
                                                                <li class="myli_for_page">Bachelor of Computer Applications [<b>BCA</b>]</li>
                                                            </ul>
                                                        </div>
                                                    </p>
