                                                        ...
                                                        <div id="integration-list" class="col-sm-12 col-lg-12 col-xs-12 col-md-12">
                                                            <ul>
                                                                <li>
                                                                    ...
                                                                    <div class="detail">
                                                                        <div id="right" style="float:right;height:100%;padding-left:20px;">
                                                                            <div id="sup">
                                                                                <p>
                                                                ...
                                                                <li>
                                                                    <a class="expand col-sm-12">
                                                                        <div class="right-arrow">+</div>
                                                                        <div>
                                                                            <h2 class="h2">Electronics and Communications Engineering (ECE)</h2>
                                                                        </div>
                                                                    </a>
                                                                    <div class="detail">
                                                                        <div id="right" style="float:right;height:100%;padding-left:20px;">
