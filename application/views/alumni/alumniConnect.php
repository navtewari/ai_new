                                        ...
                                        <article class="blog-post-wrapper single-article">
                                            ...
                                            <div class="entry-content">                                      
                                                <img class="img-responsive" style="padding-bottom: 30px;" src="<?PHP echo base_url() . 'assets/img/journal.jpg'; ?>">
												    <p align="justify"><b><h2><i class="fa fa-cog fa-spin fa-fw"></i>ACME</h2> Endeavoring thoughts towards pinnacle (ISSN: 0974 - 1763)</b></p> 
												    ...
												    <hr>
												    <p align="justify"><b><h2><i class="fa fa-cog fa-spin fa-fw"></i>AVAHAN</h2> (ISSN:  2347 - 4556)</b> A peer reviewed journal of Hospitality & Tourism Research</b></p>
