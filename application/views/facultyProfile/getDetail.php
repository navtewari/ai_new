                        ...
                        <div class="inner-content">
                            ...
                            <div class="row four-column">
                                ...
                                <h5>&nbsp;&nbsp;Click on Tab for profile printing</h5>  
                                    <a href="<?PHP echo site_url('agi/getFacultybyID/0'); ?>" target='_blank'><div class='profile' align="center"> 
                                    ...
                                    <?php foreach ($fac_profile as $item) { ?>
                                        <div class='profile' align="center"> 
                                            <a href="<?PHP echo site_url('agi/getFacultybyID/' . $item->profileID); ?>" target='_blank'>  
                                            ...
                                            <p class="cross"><a href="<?PHP echo site_url('agi/deleteFacultyProfile/' . $item->profileID); ?>" class="btn-danger">&nbsp;X&nbsp;</a></p>
                                        </div>
                                    <?php } ?>
                                </div><!-- /#grid -->
                            </div><!-- /.row -->
